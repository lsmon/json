...
Value::Value(const std::variant<int, double, bool, std::string> &value)  {
    set((const std::variant<int, double, bool, std::basic_string<char>, std::shared_ptr<JSONObject>, std::shared_ptr<JSONArray>> &) value);
}
...
void Value::set(
        const std::variant<int, double, bool, std::string, std::shared_ptr<JSONObject>, std::shared_ptr<JSONArray>> &r) {
    record = r;
}

std::variant<int, double, bool, std::string, std::shared_ptr<JSONObject>, std::shared_ptr<JSONArray>>
Value::get() const {
    return record;
}
...
void JSONObject::put(const std::string &key, const std::variant<int, double, bool, std::string> &r) {
    Value v(r);
    object[key] = v;
}
